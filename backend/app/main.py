...
NOTICE_TYPES = [
    ...
    {
        "key": "nor_amendment",
        "label": "Change to Notice of Race",
        "heading": "Notices of Race",
        "description": "Amend a clause in the published notice of race for an event.",
        "fields": [
            _nf("series_id", "Event / Series", "series"),
            _nf("class_id", "Class / Fleet", "class"),
            _nf("nor_number", "NOR number being changed", "text", "Example: NOR 4.1", True),
            _nf("instruction_number", "Existing instruction number", "text",
                "Example: 4.1 as published on 1 March 2026"),
            _nf("existing_wording", "Existing wording", "textarea",
                "Example: Boats may not use spinnakers unless they appear on the approved spinnaker list."),
            _nf("new_wording", "New wording", "textarea",
                "Example: NOR 4.1 is amended to read: Spinnakers are permitted for all fleets.", True),
            _nf("reason", "Reason for change", "textarea",
                "Example: To align the event with the class association's amended class rules."),
            _nf("effective_at", "Effective date/time", "text",
                "Example: From 09:00 on Saturday 29 August"),
            _nf("race_event_affected", "Race / event affected", "text",
                "Example: Summer Series — all remaining races"),
